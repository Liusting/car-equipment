...
Page({
  data: {
    ...
    scrollIfSel: true,
    spList: [{"money":100,"imageUrl":"https://g-search1.alicdn.com/img/bao/uploaded/i4/i2/1610923841/O1CN01e2cBsp1eFDlDHPui6_!!0-item_pic.jpg_580x580Q90.jpg_.webp","name":"增压淋浴花洒喷头淋雨花酒家用高压洗澡沐浴淋浴头莲蓬头软管套装","shopName":"壹品印象旗舰店","id":"10","place":"浙江 金华","shopId":"2"}], //商品列表
    groupList: [], //商品筛选条件
    clickGroupObj: {},
    navshow: false,
    clearSearch: false,
